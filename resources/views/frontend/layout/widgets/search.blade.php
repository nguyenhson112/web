    ...
    <div class="shopping__cart">
        <div class="shopping__cart__inner">
            ...
            <div class="shp__cart__wrap">
                ...
                <div class="shp__single__product">
                    ...
                    <div class="shp__pro__details">
                        ...
                        <span class="quantity">Số lượng: {{$item['qty']}}</span>
                        <span class="shp__price">Tổng: {{number_format($item['price']*$item['qty'])}}</span>
                    </div>
                    <div class="remove__btn">
                        {{-- <a href="#" title="Remove this item"><i class="zmdi zmdi-close"></i></a> --}}
                        <a onclick="return confirm('Bạn ơi có xóa không?')" href="{{route('cart.delete',$id)}}"><i
            ...
            <ul class="shopping__btn">
                ...
                <li class="shp__checkout"><a href="{{route('order.create')}}">Thanh toán</a></li>
            </ul>
        </div>
    </div>
    <!-- End Cart Panel -->
