        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">DS sản phẩm</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img width="50px"
                                            src="<?=$item->product_avatar?asset($item->product_avatar):asset('upload/no-image.png')?>" />
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm btn-primary" href="{{route('editProduct',$item->id)}}"
                                            role="button">
                                        ...
                                        <a onclick="return confirm('Bạn muốn xóa?')" class="btn btn-sm btn-danger"
                                            href="{{route('deleteProduct',$item->id)}}" role="button">
