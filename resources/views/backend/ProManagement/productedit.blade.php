        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Sửasp</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                    ...
                    <form   method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name"  class="form-control" value="{{$listProduct['product_name']}}"
                            ...
                            <div class="form-group">
                                <label for="">Giá</label>
                                <input type="number" name="price"  class="form-control" value="{{$listProduct['product_price']}}"
                                    aria-describedby="helpId">
                            </div>
                            <div class="form-group">
                                <label for="">Số lượng</label>
                                <input type="number" name="quantity"  class="form-control" value="{{$listProduct['quantity']}}"
                                    aria-describedby="helpId">
                            </div>
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" class="form-control"  value="{{$listProduct['product_description']}}"
                                    aria-describedby="helpId">
                            </div>
